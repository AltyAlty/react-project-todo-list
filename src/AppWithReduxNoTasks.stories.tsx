...
"Provider". Но мы в данном случае будем использовать декоратор, чтобы передать в наш компонент заранее заготовленный
контекст.*/
export default {
...
export const AppWithReduxNoTasksBaseExample = () => {
    return <AppWithReduxNoTasks/>
};